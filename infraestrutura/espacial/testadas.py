...
class ServicoTestadas:
    """Fachada para serviços de testadas."""

    def calcular(self, lote_geom, camada_lotes, camada_logradouros, max_dist_m=DEFAULT_MAX_DIST_TESTADA_M):
        return calcular_testadas_e_logradouros(lote_geom, camada_lotes, camada_logradouros, max_dist_m)
